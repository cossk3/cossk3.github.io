...
---
# 개발 기능
> <a style="text-decoration:none;color:black;">● 서버와 Mqtt 통신 통해 단말 상태 정보 전송</a>   
> <a style="text-decoration:none;color:black;">● 단말들 간 ZeroMQ 통신 통해 영상 동기화 모듈 개발</a>   
> <a style="text-decoration:none;color:black;">● http 통신 통해 스케쥴(이미지 및 영상) 다운로더 개발</a>   
> 
