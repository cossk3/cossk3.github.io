...
+ SpiderKeeper Open Source
+ 데이터 수집 및 프로세스 관리 위해 사용
+ Scrapy 기능을 통해 프로젝트 배포 및 제어

<h2 id="a2">공공 API Restful 크롤링 모듈 개발</h2>

+ 재난 공공 API 관련 크롤링 모듈 개발 (python)

<h3 id="a3">Solr와 MongoDB 연동</h3>

+ MongoDB 데이터 색인을 위해 Solr 검색엔진 연동 -->