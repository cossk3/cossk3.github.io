...
# 개발 기능
> **[라이브러리]**
> <a style="text-decoration:none;color:black;">● provider</a>   
> <a style="text-decoration:none;color:black;">● flutter_bloc</a>    
> <a style="text-decoration:none;color:black;">● home_widget</a>   
> <a style="text-decoration:none;color:black;">● sqflite</a>   
>    
> **[개발은 되어있지만 적용은 안된 기능]**
> <a style="text-decoration:none;color:black;">● Firebase Cloud Messaging</a>   
> <a style="text-decoration:none;color:black;">● workmanager 라이브러리 사용한 백그라운드 서비스 기능</a>   
>    
